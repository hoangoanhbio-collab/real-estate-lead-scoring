...
# Custom CSS cho giao diện Tím - Hồng - Trắng Premium (Purple-Pink-White Glassmorphic)
st.markdown("""
<style>
    ...
    * {
    ...
    /* Giao diện nền tối tím hồng */
    .stApp {
        background: radial-gradient(circle at top right, #200d3d, #0d0516);
        color: #ffffff;
    }
    ...
    .main-title {
        ...
        text-shadow: 0 10px 20px rgba(217, 70, 239, 0.15);
    }
    ...
    /* Nút bấm của hành động nhanh (Màu hồng fuchsia) */
    div.stButton > button {
    ...
    /* Hộp thông tin chỉ số (Metric Box) Glassmorphism màu tím hồng */
    .metric-card {
        background: rgba(28, 11, 46, 0.45);
...
if len(filtered_df) > 0:
    ...
    st.markdown(f"""
    <div class="crm-panel">
        <h4 style="color:#f472b6;margin-bottom:10px;margin-top:0;">🏢 Khách hàng: {customer_data['Họ và tên']} ({customer_data['Số điện thoại']})</h4>
